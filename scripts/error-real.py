...
def generate_plot():
    setup_latex_plots()
    data = np.load("src/error-real.npz")
    ...
    fig, (ax0) = plt.subplots(1, 1, figsize=(TEXT_WIDTH, 0.4*TEXT_WIDTH), sharex=True)
    ...
    # leave_times = np.append(leave_times, 845)
    ...
    ax0.text(2100, -2.71, r"\small Brak detekcji")
