...
def generate_plot():
    setup_latex_plots()
    data = np.load("src/fsm-adaptive-bad.npz")
    ...
    fig, (ax0, ax1, ax2) = plt.subplots(3, 1, figsize=(TEXT_WIDTH, 0.72*TEXT_WIDTH), sharex=True, gridspec_kw={'height_ratios': [0.5/1.618, 1, 1/1.618]})
